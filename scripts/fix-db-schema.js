...
mongoose
  ...
  .then(async () => {
    ...
    // Step 1: Drop the existing incorrect index
    try {
    ...
    // Step 2: Create a new index on the correct field
    try {
    ...
    // Step 3: Update existing documents to move data from userName to username
    try {
